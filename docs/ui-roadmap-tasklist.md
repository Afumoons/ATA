...
- Note: Review, Execution, and Drift now have dedicated hierarchy/dossier passes, but the roadmap item stays open until the same polish is consistent across the remaining dense pages.
