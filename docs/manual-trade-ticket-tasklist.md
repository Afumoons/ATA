...
- [ ] Define final product scope for manual trade ticket
- [ ] Define supported order types for first version
  - [ ] Market
  - [ ] Pending / limit
- [ ] Define supported risk input modes
  - [ ] Risk in money
  - [ ] Risk in % equity
- [ ] Define supported SL/TP input modes
  - [ ] by pips
  - [ ] by absolute asset price
- [ ] Define validation rules per symbol class (forex, metals, crypto)
- [ ] Define execution safety rules for manual ticket flow
