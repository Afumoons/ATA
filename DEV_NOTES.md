...
- Next highest-value slice after this is T7 UI integration: wire the manual ticket page to the new submit endpoint, then surface explicit manual labels/filters/panels in execution monitoring and audit views
