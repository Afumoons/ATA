...
- Next highest-value slice after this is T7 lifecycle visibility: add manual trade journal/reconciliation support and explicit manual visibility controls on the Audit timeline, then wire the manual ticket page to the live submit endpoint once monitoring coverage is complete enough
