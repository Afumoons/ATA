...
- Next highest-value slice after this is T7 lifecycle depth: add journal/reconciliation support for manual trade lifecycle, then wire the manual ticket page to the live submit endpoint once monitoring coverage is complete enough
