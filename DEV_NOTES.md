...
- Next highest-value slice after this is the first T6 live-submit scaffold: backend submit endpoint for manual market/limit orders, pre/post audit persistence, and duplicate-submit protection while preserving the manual_user markers already validated in preview
