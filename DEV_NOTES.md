...
- Next highest-value slice after this is T8 hardening for missing MT5/account info and symbol-spec fetch failures, or wiring the manual ticket page to the live submit endpoint once the operator flow is ready to expose explicit submit controls
